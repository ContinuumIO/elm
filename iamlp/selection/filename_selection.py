...
def include_file(filename, band_specs, no_file_open=True, **selection_kwargs):
    ...
    return _select_band_from_file_base(filename, band_specs, **selection_kwargs)

def get_included_files(filenames_gen, band_specs, no_file_open=True, **selection_kwargs):
